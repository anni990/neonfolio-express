  ...
  const researchWorks: Research[] = [
    {
      ...
      diaryNumber: '26283/2024-CO/L',
      link: '/pdf/copyright-new.pdf',
    },
    {
          ...
          {researchWorks.map((research, index) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                {/* if first data then show the pdf and if second data then show the copyright search */}
                {index === 0 && research.link && (
                  <a href={research.link} target="_blank" rel="noopener noreferrer" className="inline-flex items-center text-code-green hover:text-code-green/80 transition-colors">
                    View CopyRight PDF
