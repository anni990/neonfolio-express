...
import { Code, Database, Globe, Layout, Radio, User } from 'lucide-react';
...
const About = () => {
  ...
  const interests = [
    ...
    { icon: <Code className="w-5 h-5" />, label: 'Software Architecture' },
    { icon: <User className="w-5 h-5" />, label: 'UX Design' },
  ];
        ...
        <div className="flex flex-col md:flex-row gap-16">
          ...
          <div className="md:w-2/5 relative">
            <div className="relative">
              <div className="aspect-[4/5] bg-gradient-to-br from-code-blue/40 to-code-green/40 rounded-2xl overflow-hidden glass-panel">
              ...
              {/* Decorative elements */}
              <div className="absolute -top-6 -left-6 w-24 h-24 border border-code-blue/20 rounded-xl rotate-6" />
              <div className="absolute -bottom-6 -right-6 w-24 h-24 border border-code-green/20 rounded-xl -rotate-6" />
              
              {/* Code snippet */}
              <div className="absolute -bottom-8 -left-4 md:-left-12 glass-panel px-6 py-4 rounded-xl shadow-lg">
                <pre className="text-xs md:text-sm font-mono text-code-dark">
          ...
          <div className="md:w-3/5" ref={contentRef}>
            ...
            <p className="text-lg text-foreground/80 mb-6 opacity-0">
            ...
            <p className="text-lg text-foreground/80 mb-10 opacity-0">
            ...
            <div className="mb-10 opacity-0">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                {interests.map((interest, index) => (
                  <div key={index} className="flex items-center gap-3 p-3 rounded-lg hover:bg-code-blue/5 transition-colors">
                    <div className="w-10 h-10 rounded-lg bg-code-blue/10 flex items-center justify-center text-code-blue">
                      {interest.icon}
                    </div>
            ...
            <div className="opacity-0">
              <a 
                href="#contact"
                className="inline-flex items-center px-6 py-3 rounded-lg bg-code-blue text-white font-medium transition-all hover:shadow-lg hover:shadow-code-blue/20 hover:translate-y-[-2px]"
                onClick={(e) => {
                  e.preventDefault();
